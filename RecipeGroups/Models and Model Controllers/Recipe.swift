...
final class Recipe: Codable {
    ...
    static func loadSampleRecipes() -> [Recipe] {
        let macaronSteps = [
            ...
            "Let the macarons sit at room temperature for 30 minutes to 1 hour, until dry to the touch", "Preheat the oven to 300˚F (150˚C)",
        ...
        let cherryPieSteps = [
            ...
            "On a lightly floured surface, roll out larger ball to fit a 9-in. pie plate. Transfer dough to pie plate; trim even with edge of plate. Add filling. Roll out remaining dough; make a lattice crust. Trim, seal and flute edges",
